...
| SmolLM3 3B | `single_request_latency` | SGLang | 58.0 ms | 59.8 ms | 2052.8 ms | 62.1 | 0.49 | 100.0% |
...
| Granite 8B | `single_request_latency` | SGLang | 75.6 ms | 76.4 ms | 4646.1 ms | 27.6 | 0.22 | 100.0% |
...
| Granite 8B | `throughput_ramp` | SGLang | 75.7 ms | 199.1 ms | 12471.4 ms | 92.8 | 0.36 | 100.0% |
...
### SmolLM3 3B
- Only SGLang completed the single-request benchmark on this setup.
- Only SGLang completed the throughput ramp on this setup.
### Llama 3.2 3B
- vLLM won the single-request TTFT comparison.
