...
LOG="results/phase3_resume_from_qwen_$(date +%Y%m%d_%H%M%S).log"
...
update_status "STARTED phase3-resume-from-qwen log=$LOG"
echo "== Phase 3 resume from Qwen + remaining models =="
date -u
printf 'Log file: %s\n' "$LOG"
...
echo "== Phase 3 qwen+remaining models complete =="
date -u
